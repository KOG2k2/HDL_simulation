...
//	switch(mode){
//	case NORMAL:
//		if (isButtonPressed(BUTTON1_Pin) == 1) mode = SEC_CHANGE;
//		break;
//	case SEC_CHANGE:
//		if (isButtonPressed(BUTTON1_Pin) == 1) mode = MIN_CHANGE;
//		break;
//	case MIN_CHANGE:
//		if (isButtonPressed(BUTTON1_Pin) == 1) mode = HOUR_CHANGE;
//		break;
//	case HOUR_CHANGE:
//		if (isButtonPressed(BUTTON1_Pin) == 1) mode = NORMAL;
//		break;
//	default:
//		break;
